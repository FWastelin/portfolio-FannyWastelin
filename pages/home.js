      ...
      <article class="projet">
        ...
        <section class="img-projet">
          <section class="ligne1">
            ...
            <div class="hackaton"><div class="img-haka"><span class="texte">Projet Hackathon 2020 pour promouvoir l'informatique au féminin.<button class="voir-hacka">En voir plus</button></span></div></div>
          </section>
